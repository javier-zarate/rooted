  ...
  return (
    <LegalWrapper>
      ...
      <p>
        ...
        <br />
        This website is operated by RootedFamily. Throughout the site, the terms
        &ldquo;we&rdquo;, &ldquo;us&rdquo; and &ldquo;our&rdquo; refer to
        RootedFamily. RootedFamily offers this website, including all
        ...
        <br />
        In no case shall RootedFamily, our directors, officers, employees,
        ...
        <br />
        You agree to indemnify, defend and hold harmless RootedFamily and our
